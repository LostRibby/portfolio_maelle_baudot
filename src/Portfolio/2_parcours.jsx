            ...
            <div id="parcours" className={style.body}>
                <div className={style.parcoursContainer}>
                    ...
                    <div className={style.parcours}>
                        ...
                        <div className={style.parcours1}>
                            <h3>CESS 🎓</h3>
                            <p>En juin 2023 j'ai obtenu mon CESS à l'Institut Saint-Luc de Bruxelles en Qualification Art Plastique où j'ai également eu mon brevet d'art plastiques.</p>
                        </div>
                        <div className={style.parcours1}>
